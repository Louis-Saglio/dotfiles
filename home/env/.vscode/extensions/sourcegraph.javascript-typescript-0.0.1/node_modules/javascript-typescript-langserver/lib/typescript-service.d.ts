...
import { InitializeParams, PackageDescriptor, SymbolDescriptor, SymbolLocationInformation, WorkspaceReferenceParams, WorkspaceSymbolParams } from './request-type';
...
export declare class TypeScriptService {
     ...
     */
    initialize(params: InitializeParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    shutdown(params?: {}, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    textDocumentDefinition(params: TextDocumentPositionParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    textDocumentXdefinition(params: TextDocumentPositionParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    textDocumentHover(params: TextDocumentPositionParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     * @return Observable of JSON Patches that build a `Location[]` result
     */
    textDocumentReferences(params: ReferenceParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    workspaceSymbol(params: WorkspaceSymbolParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     * @return Observable of JSON Patches that build a `SymbolInformation[]` result
     */
    textDocumentDocumentSymbol(params: DocumentSymbolParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    workspaceXreferences(params: WorkspaceReferenceParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    workspaceXpackages(params?: {}, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    workspaceXdependencies(params?: {}, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    textDocumentCompletion(params: TextDocumentPositionParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    textDocumentSignatureHelp(params: TextDocumentPositionParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    textDocumentCodeAction(params: CodeActionParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     ...
     */
    workspaceExecuteCommand(params: ExecuteCommandParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
     * Executes the `codeFix` command
     *
     * @return Observable of JSON Patches for `null` result
     */
    executeCodeFixCommand(fileTextChanges: ts.FileTextChanges[], span?: Span): Observable<jsonpatch.Operation>;
    /**
     * The rename request is sent from the client to the server to perform a workspace-wide rename of a symbol.
     *
     * @return Observable of JSON Patches that build a `WorkspaceEdit` result
     */
    textDocumentRename(params: RenameParams, span?: Span): Observable<jsonpatch.Operation>;
    /**
