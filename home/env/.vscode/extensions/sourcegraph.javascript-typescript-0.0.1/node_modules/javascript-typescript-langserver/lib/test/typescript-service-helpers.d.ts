 ...
 */
export declare const initializeTypeScriptService: (createService: TypeScriptServiceFactory, rootUri: string, files: Map<string, string>) => (this: TestContext & IBeforeAndAfterContext) => Promise<void>;
/**
 ...
 */
export declare function describeTypeScriptService(createService: TypeScriptServiceFactory, shutdownService: ((this: TestContext & IBeforeAndAfterContext) => Promise<void>) | undefined, rootUri: string): void;
