 ...
 */
exports.initializeTypeScriptService = (createService, rootUri, files) => function () {
        ...
        describe('textDocumentDefinition()', function () {
            specify('in same file', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    }).reduce(fast_json_patch_1.default.applyReducer, null).toPromise();
    ...
    describe('Workspace with root package.json', function () {
        ...
        describe('workspaceSymbol()', function () {
            ...
            describe('with text query', function () {
                it('should find a symbol', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        const result = yield this.service.workspaceSymbol({ query: 'a' }).reduce(fast_json_patch_1.default.applyReducer, null).toPromise();
                        assert.deepEqual(result, [{
                                kind: vscode_languageserver_types_1.SymbolKind.Class,
                                location: {
                                    range: {
                ...
                it('should return all symbols for an empty query excluding dependencies', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        const result = yield this.service.workspaceSymbol({ query: '' })
                            .reduce(fast_json_patch_1.default.applyReducer, null)
                            .toPromise();
                        assert.deepEqual(result, [
                            {
                                name: 'a',
        ...
        describe('workspaceXreferences()', function () {
            ...
            it('should return no references to a method if hinted dependee package name was not found', function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.service.workspaceXreferences({ query: { name: 'foo', kind: 'method', containerName: 'a' }, hints: { dependeePackageName: 'NOT-mypkg' } }).reduce(fast_json_patch_1.default.applyReducer, null).toPromise();
                    assert.deepEqual(result, []);
                });
            });
        ...
        it('should error on an invalid symbol', function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield assert.isRejected(this.service.textDocumentRename({
                    ...
                    newName: 'asdf'
                }).reduce(fast_json_patch_1.default.applyReducer, null).toPromise(), 'This symbol cannot be renamed');
            });
        });
