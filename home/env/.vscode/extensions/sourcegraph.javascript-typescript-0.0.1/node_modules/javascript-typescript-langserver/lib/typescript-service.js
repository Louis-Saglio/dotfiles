...
class TypeScriptService {
    ...
    initialize(params, span = new opentracing_1.Span()) {
        if (params.rootUri || params.rootPath) {
            ...
            this.projectManager = new project_manager_1.ProjectManager(this.root, this.inMemoryFileSystem, this.updater, this.traceModuleResolution, this.logger);
    ...
    _publishDiagnostics(uri, span = new opentracing_1.Span()) {
        ...
        const sourceFile = program.getSourceFile(util_1.uri2path(uri));
        if (!sourceFile) {
            return;
        }
