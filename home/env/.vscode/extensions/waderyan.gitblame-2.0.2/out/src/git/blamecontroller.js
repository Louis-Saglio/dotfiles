...
class GitBlameController {
    ...
    setupDisposables() {
        ...
        this.disposable = vscode_1.Disposable.from(this.statusBarView, this.gitBlame, errorHandler);
    }
    setupListeners() {
        const disposables = [];
    ...
    showMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const messageFormat = configuration_1.getProperty(configuration_1.Properties.InfoMessageFormat);
    ...
    getToolUrl(commitInfo) {
        ...
        const parsedUrl = textdecorator_1.TextDecorator.parseTokens(configuration_1.getProperty(configuration_1.Properties.CommitUrl), {
